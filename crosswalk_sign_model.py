...
train_generator = traindata_gen.flow_from_directory('train/', class_mode='categorical', shuffle = True, target_size=(640, 300), batch_size = 64)

validation_generator = traindata_gen.flow_from_directory('test/', class_mode='categorical', target_size=(640, 300), shuffle = False, batch_size = 64)
...
model.save('crosswalk_sign_model.h5')
